...
$appServicePlanQueue="Cloud-ComputingHW2-Queue-$randomIdentifier"
$appServicePlanQueueServiceAPI="Cloud-ComputingHW2-Queue-ServiceAPI-$randomIdentifier"
...
echo "Creating $appServicePlanQueue"
az appservice plan create --name $appServicePlanQueue --resource-group $resourceGroup --sku FREE

echo "Creating $appServicePlanQueueServiceAPI"
az appservice plan create --name $appServicePlanQueueServiceAPI --resource-group $resourceGroup --sku FREE
#############################################################
...
$QueueAPIwebApp = az webapp create --name $webappQueue --resource-group $resourceGroup --plan $appServicePlanQueue | ConvertFrom-Json
...
$QueueServiceApiNodeA = az webapp create --name $webappAPI --resource-group $resourceGroup --plan $appServicePlanQueueServiceAPI | ConvertFrom-Json
...
$QueueServiceApiNodeB = az webapp create --name $webappAPI2 --resource-group $resourceGroup --plan $appServicePlanQueueServiceAPI | ConvertFrom-Json
